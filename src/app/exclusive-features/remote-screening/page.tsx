...
export default function RemoteScreeningComingSoon() {
  return (
    <main className="min-h-screen bg-[#F9F6F1] flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden relative">
      ...
      >
        ...
        <strong>Remote Health Screening</strong> feature. Soon, you’ll be able
        to check your pet’s symptoms from home with expert-designed guidance —
        making pet care even easier and faster.
      </motion.p>
