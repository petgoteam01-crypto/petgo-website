    ...
    <main className="min-h-screen bg-[#F9F6F1] text-[#111827] py-16 px-6">
      ...
      <section className="text-center max-w-3xl mx-auto mb-12">
        ...
        <p className="text-gray-700 leading-relaxed">
          The puppies are growing rapidly and will soon start to interact with the world around them.
        </p>
      </section>
      ...
      <section className="max-w-3xl mx-auto mb-12 bg-white p-8 rounded-2xl shadow-sm">
        ...
        <ol className="list-decimal list-inside space-y-3 text-gray-700">
          <li>
            <strong>Rapid Weight Gain</strong> — After the first week of life, a puppy's body weight will have doubled from its birth weight! This rapid growth is a sign of healthy development.
          </li>
          <li>
            <strong>Tail Wags Begin</strong> — Around two weeks of age, puppies will start to wag their tails! This is a wonderful early milestone of their physical and social development.
          </li>
          <li>
            <strong>Limited Response to Stimuli</strong> — At this stage, puppies cannot yet react to external stimuli. Their eyes are just beginning to open (if they haven't already), and their hearing is still developing.
          </li>
        </ol>
      </section>
      ...
      <section className="max-w-3xl mx-auto mb-12 bg-[#FFF9E6] border border-[#F5D97A] p-6 rounded-xl">
        <h4 className="font-semibold text-[#8B6A43] mb-2">
          Hygiene and Elimination Management
        </h4>
        <p className="text-gray-700 leading-relaxed">
          Keep your puppies growing strong and healthy with the help of 'Meongnang Bogam' (Dog-Sitter's Wisdom - the service name)!
        </p>
      </section>

      {/* ===== WIPING DOWN WITH A TOWEL ===== */}
      <section className="max-w-3xl mx-auto mb-12 bg-white p-8 rounded-2xl shadow-sm">
        <h4 className="font-semibold mb-4">Wiping Down with a Towel</h4>
        <ul className="list-disc list-inside space-y-3 text-gray-700">
          <li>
            <strong>Cleaning the Fur</strong> — After about six days of life, urine and feces may start to stick to the puppies' fur.
          </li>
          <li>
            <strong>How to Clean</strong> — Dampen a towel with warm water and gently wipe the puppies clean. This prevents irritation and keeps their environment hygienic.
          </li>
        </ul>
      </section>
      ...
      <section className="max-w-3xl mx-auto mb-12 bg-[#FFF9E6] border border-[#F5D97A] p-6 rounded-xl">
        <h4 className="font-semibold text-[#8B6A43] mb-2">
          Methods for Stimulating Elimination
        </h4>
        <p className="text-gray-700 leading-relaxed mb-3">
          Newborn puppies cannot urinate or defecate on their own!
        </p>
        <p className="text-gray-700 leading-relaxed">
          The mother dog typically helps her puppies eliminate, but in special circumstances where the mother dog is not stimulating them, or if the mother dog is exhausted from rearing the litter, the guardian must step in to help.
        </p>
      </section>

      {/* ===== STIMULATING ELIMINATION ===== */}
      <section className="max-w-3xl mx-auto mb-12 bg-white p-8 rounded-2xl shadow-sm">
        <h4 className="font-semibold mb-4">Stimulating Elimination</h4>
        <ul className="list-disc list-inside space-y-3 text-gray-700">
          <li>
            <strong>When to Stimulate</strong> — Stimulate elimination after every feeding or when the puppy starts crying (which can indicate a full bladder or bowel).
          </li>
          <li>
            <strong>The Method</strong> — Use a cotton ball, soft tissue, or a clean cloth (a small piece of towel) moistened with lukewarm water. Gently massage or lightly rub the puppy's genital and anal area until they eliminate.
          </li>
        </ul>
        <p className="text-gray-700 leading-relaxed mt-4">
          This manual stimulation is crucial to their health in these early weeks, ensuring their bladder and bowels are emptied regularly.
        </p>
      </section>
